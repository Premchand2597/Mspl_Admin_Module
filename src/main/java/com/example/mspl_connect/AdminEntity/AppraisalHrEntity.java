...
public class AppraisalHrEntity {
    ...
    private Date apprisalSendDate;

    @Column(name = "apprisal_submit_date")
    private Date apprisalSubmitDate;

    @Column(name = "apprisal_submit_date_admin")
    private Date apprisalSubmitDateAdmin;
    ...
    public Date getApprisalSendDate() {
		return apprisalSendDate;
	}

	public void setApprisalSendDate(Date apprisalSendDate) {
		this.apprisalSendDate = apprisalSendDate;
	}

	public Date getApprisalSubmitDate() {
		return apprisalSubmitDate;
	}

	public void setApprisalSubmitDate(Date apprisalSubmitDate) {
		this.apprisalSubmitDate = apprisalSubmitDate;
	}

	public Date getApprisalSubmitDateAdmin() {
		return apprisalSubmitDateAdmin;
	}

	public void setApprisalSubmitDateAdmin(Date apprisalSubmitDateAdmin) {
