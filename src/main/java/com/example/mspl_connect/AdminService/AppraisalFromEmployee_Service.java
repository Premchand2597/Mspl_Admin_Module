...
import com.example.mspl_connect.AdminRepo.AppraisalMaxscoreAllottedscoreOverallpercentOverallRatingInsert_Repo;
import com.example.mspl_connect.AdminRepo.AppraisalSubmittedCountWithEmpId_Repo;
import com.example.mspl_connect.AdminRepo.AppraisalSubmittedNotSubmittedCount_Repo;
import com.example.mspl_connect.AdminRepo.AppraisalTracker_Repo;
...
public class AppraisalFromEmployee_Service {
	...
	@Autowired
	private AppraisalTracker_Repo appraisalTracker_Repo;
	
	@Autowired
	private AppraisalSubmittedNotSubmittedCount_Repo appraisalSubmittedNotSubmittedCount_Repo;
...
public List<Appraisal_Maxscore_Allottedscore_Overallpercent_OverallRating_DTO> getAppraisalMaxScoreAllottedScoreOverallPercentageOverallRatingDataByUser(String empId, String financialYearRange) {
	...
	public List<AppraisalTracker_Entity> getAppraisalTrackedBasedOnClickedMonthAndYear(String clickedQuarterMonthYear){
		return appraisalTracker_Repo.fetchAppraisalTrackedBasedOnClickedMonthAndYear(clickedQuarterMonthYear);
	}
	
	public AppraisalSubmittedNotSubmittedCount_Entity getAppraisalSubmittedNotSubmittedAndTotalCountValue(String clickedQuarterMonthYear){
		return appraisalSubmittedNotSubmittedCount_Repo.fetchAppraisalSubmittedNotSubmittedAndTotalCountValue(clickedQuarterMonthYear);
	}
	
	public List<AppraisalSubmittedCountWithEmpId_Entity> fetchAppraisalSubmittedCountWithEmpIdDetails(){
		return appraisalSubmittedCountWithEmpId_Repo.getAppraisalSubmittedCountWithEmpIdDetails();
	}
	
	@Transactional
	public void insertAllData(String emp_id, String financial_year, String max_score, String allotted_score, String overall_percentage, String overall_ratings) {
		appraisalMaxscoreAllottedscoreOverallpercentOverallRatingInsert_Repo.saveAllAprraisalData(emp_id, financial_year, max_score, allotted_score, overall_percentage, overall_ratings);
	}
