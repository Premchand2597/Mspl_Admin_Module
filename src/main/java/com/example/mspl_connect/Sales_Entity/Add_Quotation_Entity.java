...
@Entity
@Table(name ="new_quotation")
public class Add_Quotation_Entity {

	public Add_Quotation_Entity(long id, String qid, String date_time, String customerName, String customerlName,
			String gstNumber, String orderMethod, String contactPersonName, String designation, String mobileNumber,
			String emailId, String deliveryAddress, String shipmentAddress, String taxType, int review,
			String email_sent_status, String honorifics1, String honorifics2, String prepared_by,
			Integer notification_flag, String empid, List<ProductDetails> products) {
		super();
		this.id = id;
		this.qid = qid;
	...
	private Integer notification_flag;
	
	@Column(name = "empid")
	private String empid;
	
	  public Add_Quotation_Entity() {
		super();
		// TODO Auto-generated constructor stub
	}

	  
	public Add_Quotation_Entity(String qid, String date_time, String customerName, String customerlName,
			String gstNumber, String orderMethod, String contactPersonName, String designation, String mobileNumber,
	...
	public String toString() {
		return "Add_Quotation_Entity [id=" + id + ", qid=" + qid + ", date_time=" + date_time + ", customerName="
				+ customerName + ", customerlName=" + customerlName + ", gstNumber=" + gstNumber + ", orderMethod="
				+ orderMethod + ", contactPersonName=" + contactPersonName + ", designation=" + designation
				+ ", mobileNumber=" + mobileNumber + ", emailId=" + emailId + ", deliveryAddress=" + deliveryAddress
				+ ", shipmentAddress=" + shipmentAddress + ", taxType=" + taxType + ", review=" + review
				+ ", email_sent_status=" + email_sent_status + ", honorifics1=" + honorifics1 + ", honorifics2="
				+ honorifics2 + ", prepared_by=" + prepared_by + ", notification_flag=" + notification_flag + ", empid="
				+ empid + ", products=" + products + "]";
	}
	...
	public Integer getNotification_flag() {
		return notification_flag;
	}

	public void setNotification_flag(Integer notification_flag) {
		this.notification_flag = notification_flag;
	}
	...
	@ElementCollection
	@CollectionTable(name = "quotation_products", joinColumns = @JoinColumn(name = "qid", referencedColumnName = "qid"))
