...
public class Candidate_Entity {
	...
	public String getResume_doc() {
		return resume_doc;
	}

	public void setResume_doc(String resume_doc) {
	...
	public String toString() {
		return "Candidate_Entity [id=" + id + ", first_name=" + first_name + ", last_name=" + last_name + ", gender="
				+ gender + ", email=" + email + ", password=" + password + ", mobile_number=" + mobile_number + ", dob="
				+ dob + ", languages=" + languages + ", action=" + action + ", aadhar_number=" + aadhar_number
				+ ", father_name=" + father_name + ", father_designation=" + father_designation + ", mother_name="
				+ mother_name + ", mother_designation=" + mother_designation + ", marital_status_value="
				+ marital_status_value + ", corresponding_address=" + corresponding_address + ", permanent_address="
				+ permanent_address + ", qualification1=" + qualification1 + ", degree_name1=" + degree_name1
				+ ", university_name1=" + university_name1 + ", percentage1=" + percentage1 + ", year_select1="
				+ year_select1 + ", qualification2=" + qualification2 + ", degree_name2=" + degree_name2
				+ ", university_name2=" + university_name2 + ", percentage2=" + percentage2 + ", year_select2="
				+ year_select2 + ", qualification3=" + qualification3 + ", degree_name3=" + degree_name3
				+ ", university_name3=" + university_name3 + ", percentage3=" + percentage3 + ", year_select3="
				+ year_select3 + ", qualification4=" + qualification4 + ", degree_name4=" + degree_name4
				+ ", university_name4=" + university_name4 + ", percentage4=" + percentage4 + ", year_select4="
				+ year_select4 + ", qualification5=" + qualification5 + ", degree_name5=" + degree_name5
				+ ", university_name5=" + university_name5 + ", percentage5=" + percentage5 + ", year_select5="
				+ year_select5 + ", experience=" + experience + ", previous_comp_name1=" + previous_comp_name1
				+ ", year_of_exp1=" + year_of_exp1 + ", candidate_expected_salary_in_lpa="
				...
				+ ", candidate_status_flag=" + candidate_status_flag + ", exp_current_salary_in_lpa="
				+ exp_current_salary_in_lpa + ", test_status_flagg=" + test_status_flagg + ", profile_pic_path="
				+ profile_pic_path + ", pan_pic_path=" + pan_pic_path + ", aadhar_pic=" + aadhar_pic
				+ ", exp_letter_pic=" + exp_letter_pic + ", pg_pic=" + pg_pic + ", payslip_pic=" + payslip_pic
				+ ", tenth_pic=" + tenth_pic + ", puc_pic=" + puc_pic + ", degree_pic=" + degree_pic + ", voter_id_pic="
				+ voter_id_pic + ", aadhar_doc=" + aadhar_doc + ", resume_doc=" + resume_doc + "]";
	}
