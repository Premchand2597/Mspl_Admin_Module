...
public class EmployeeDetailsEntity {
	    ...
	    private String password_change_flag;
	   ...
	   /* @Column(name = "profile_pic_path")
		...
		public String toString() {
			return "EmployeeDetailsEntity [id=" + id + ", empId=" + empId + ", deptId=" + deptId + ", roleId=" + roleId
					...
					+ linkedin_link + ", twitter_link=" + twitter_link + ", alternativeSaturdayEffectiveFrom="
					+ alternativeSaturdayEffectiveFrom + ", pg_pic=" + pg_pic + ", exp_letter_pic=" + exp_letter_pic
					+ ", payslip_pic=" + payslip_pic + ", personal_email=" + personal_email + ", father_name="
					+ father_name + ", mother_name=" + mother_name + ", corr_address=" + corr_address
					...
					+ team_co_name + ", offer_letter=" + offer_letter + ", primary_emergency_contact_name="
					...
					+ secondary_emergency_contact_relation + ", password_change_flag=" + password_change_flag
					+ ", blood_group=" + blood_group + ", resignation_date=" + resignation_date + ", last_working_date="
					+ last_working_date + ", in_active_reason=" + in_active_reason + ", diploma_pic=" + diploma_pic
					+ ", bank_check_pic=" + bank_check_pic + ", other_pic=" + other_pic + ", other_pic2=" + other_pic2
					+ ", other_pic3=" + other_pic3 + ", other_pic4=" + other_pic4 + ", profilePicPath=" + profilePicPath
					+ ", panPicPath=" + panPicPath + ", aadhar_pic=" + aadhar_pic + ", tenth_pic=" + tenth_pic
					+ ", puc_pic=" + puc_pic + ", degree_pic=" + degree_pic + ", official_dob=" + official_dob
					+ ", current_salary=" + current_salary + ", probation_completed_date=" + probation_completed_date
					+ ", employee_type=" + employee_type + ", usertype=" + usertype + ", otp=" + otp + "]";
		}
		...
		public void setPassword_change_flag(String password_change_flag) {
