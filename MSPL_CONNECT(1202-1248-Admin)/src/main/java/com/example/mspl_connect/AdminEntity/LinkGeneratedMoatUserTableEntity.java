...
public class LinkGeneratedMoatUserTableEntity {
	...
	public LinkGeneratedMoatUserTableEntity(int id, String encrypted_link, String candidateEmail, String test_duration,
			String supervisor_name, String linkCreatedDate, String encryptedData, String firstAccessTime,
			String expirationTime, String test_valid_flag, String test_type) {
		super();
		this.id = id;
	...
	public LinkGeneratedMoatUserTableEntity() {
		super();
	}
	...
	public String toString() {
		return "LinkGeneratedMoatUserTableEntity [id=" + id + ", encrypted_link=" + encrypted_link + ", candidateEmail="
