		...
		public void setEmployeeEmail(String employeeEmail) {
		 ...
		 public String getFinancialYear() {
			...
			public String toString() {
				return "LeaveApplicationWithProfile [id=" + id + ", empid=" + empid + ", approvedstatus="
						+ approvedstatus + ", approved_by=" + approved_by + ", department=" + department
						+ ", employee_name=" + employee_name + ", from_date=" + from_date + ", leaveType=" + leaveType
						+ ", reason=" + reason + ", reporting_to=" + reporting_to + ", to_date=" + to_date
						+ ", employeeEmail=" + employeeEmail + ", processed=" + processed + ", rejection_reason="
						+ rejection_reason + ", way=" + way + ", previous_status=" + previous_status
						+ ", notification_status=" + notification_status + ", timestamp=" + timestamp
						+ ", status_count=" + status_count + ", is_date_modified=" + is_date_modified
			...
			public LeaveApplicationWithProfile(int id, String empid, String approvedstatus, String approved_by,
					...
					String sender_id, String leaveDuration, String remarks) {
				super();
				this.id = id;
				this.empid = empid;
				this.approvedstatus = approvedstatus;
			...
			public LeaveApplicationWithProfile() {
				super();
