...
//	List<AddQuestions_Entity> fetch_all_apptitude_questions();
	...
	@Query(nativeQuery = true, value="select * from fetch_all_apptitude_questions()")
	List<AddQuestions_Entity> fetch_all_apptitude_questions();
...
//	List<AddQuestions_Entity> fetch_all_c_questions();
	...
	@Query(nativeQuery = true, value="select * from fetch_all_c_questions()")
	List<AddQuestions_Entity> fetch_all_c_questions();
...
//	List<AddQuestions_Entity> fetch_all_java_questions();
	...
	@Query(nativeQuery = true, value="select * from fetch_all_java_questions()")
	List<AddQuestions_Entity> fetch_all_java_questions();
...
//	List<AddQuestions_Entity> fetch_all_python_questions();
	...
	@Query(nativeQuery = true, value="select * from fetch_all_python_questions()")
	List<AddQuestions_Entity> fetch_all_python_questions();
...
//	List<AddQuestions_Entity> fetch_all_sql_questions();
	...
	@Query(nativeQuery = true, value="select * from fetch_all_sql_questions()")
	List<AddQuestions_Entity> fetch_all_sql_questions();
}
