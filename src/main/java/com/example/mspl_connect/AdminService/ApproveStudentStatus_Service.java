...
public class ApproveStudentStatus_Service {
	...
	public boolean setActionStatus(String action_satus, String id, String candidate_action_reason) {
		...
		String userLoginStatusExpirationDate=null;
		...
		if(action_satus.equals("approv")) {
		    ...
		    userLoginStatusExpirationDate = expirationDate.format(formatter);			
		}else if(action_satus.equals("onhold")) {
			notificationFlagValue = 4;
		}
		
        int rowsAffected = approveStudentStatus_Repo.changeApproveStatus(action_satus, id, candidate_action_reason, notificationFlagValue, userLoginStatusExpirationDate);
