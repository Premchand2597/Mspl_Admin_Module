...
@Entity
@Table(name = "performa_invoice_item")
public class PerformaInvoiceItem {
    ...
    @JoinColumn(name = "performa_invoice_id")
    @JsonBackReference
    ...
    public String toString() {
        return "PurchaseInvoiceItem [id=" + id + ", partNo=" + partNo + ", hsnCode=" + hsnCode + ", description="
                ...
                (performaInvoice != null ? performaInvoice.getId() : "null") + "]";
    }
	...
	public PerformaInvoice getPerformaInvoice() {
		return performaInvoice;
	}

	public void setPerformaInvoice(PerformaInvoice performaInvoice) {
		this.performaInvoice = performaInvoice;
	}

	public PerformaInvoiceItem(Long id, String partNo, String hsnCode, String description, Integer quantity,
