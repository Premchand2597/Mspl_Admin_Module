    ...
    $.get("/flag", function(response) {
      ...
      //display the to-do List event notification
        ...
        if(leaveRequestCountValue.newReleaseNoteNotification > 0){
             ...
             $("#new-releasetext").html("Latest Release <span style='display:block;'>There is a latest release available! Click here to see the details.<br> Version:V.0.1.0</span>");
