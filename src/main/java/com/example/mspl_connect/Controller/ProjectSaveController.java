...
///projectService.updateprojectFlag();//updateAcceptedPrj	
	...
	public String insertAssignedCompanyProject(
	 ...
	 @GetMapping("/employees/byDepartment/{departmentName}")
	 public ResponseEntity<List<EmployeeNameEmailDTO>> getEmployeesByDepartment(@PathVariable String departmentName) {
		 
		   System.out.println(",,,,,,"+departmentName);
		   
		   Integer deptId = departmentRepo.findDeptIdByDeptName(departmentName);
		   List<EmployeeNameEmailDTO> employees = empDetailsService.findUserByDepartment1(deptId);
