...
public class PerformaInvoice {
    ...
    @Column(name = "performa_invoice_id")  // This maps to the DB column
    ...
    @OneToMany(mappedBy = "performaInvoice", cascade = CascadeType.ALL, orphanRemoval = true)
    @JsonManagedReference
    private List<PerformaInvoiceItem> items = new ArrayList<>();
	...
	public List<PerformaInvoiceItem> getItems() {
		return items;
	}

	public void setItems(List<PerformaInvoiceItem> items) {
		this.items = items;
	}
	...
	public String toString() {
		return "PerformaInvoice [id=" + id + ", poNumber=" + poNumber + ", poDate=" + poDate + ", vendorCode="
