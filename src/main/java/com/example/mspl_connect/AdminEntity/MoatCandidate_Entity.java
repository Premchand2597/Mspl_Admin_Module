...
@Entity
@Table(name="student")
public class MoatCandidate_Entity {
	...
	/*@Lob
	private byte[] profile_pic_path;
	    
    @Lob
    private byte[] pan_pic_path;
    
    @Lob
    private byte[] aadhar_pic;
    
    @Lob
    private byte[] voter_id_pic;
    
    @Lob
    private byte[] tenth_pic;
    
    @Lob
    private byte[] puc_pic;
    
    @Lob
    private byte[] degree_pic;*/
	
	private String first_ctc_offer;
	private String candidate_response_for_first_ctc_offer;
	private String candidate_remark_for_first_ctc_offer;
	private String second_ctc_offer;
	private String candidate_response_for_second_ctc_offer;
	private String candidate_remark_for_second_ctc_offer;
	private String third_ctc_offer;
	private String candidate_response_for_third_ctc_offer;
	private String candidate_remark_for_third_ctc_offer;
	private String exp_current_salary_in_lpa;
	private String doc_upload_flag;
	private String test_status_flagg;
	private String user_login_status_expiration;
	...
	public String getFirst_ctc_offer() {
		return first_ctc_offer;
	}

	public void setFirst_ctc_offer(String first_ctc_offer) {
		this.first_ctc_offer = first_ctc_offer;
	}
	...
	public String getCandidate_remark_for_first_ctc_offer() {
		return candidate_remark_for_first_ctc_offer;
	}

	public void setCandidate_remark_for_first_ctc_offer(String candidate_remark_for_first_ctc_offer) {
		this.candidate_remark_for_first_ctc_offer = candidate_remark_for_first_ctc_offer;
	}

	public String getSecond_ctc_offer() {
		return second_ctc_offer;
	}

	public void setSecond_ctc_offer(String second_ctc_offer) {
		this.second_ctc_offer = second_ctc_offer;
	}
	...
	public String getCandidate_remark_for_second_ctc_offer() {
		return candidate_remark_for_second_ctc_offer;
	}

	public void setCandidate_remark_for_second_ctc_offer(String candidate_remark_for_second_ctc_offer) {
		this.candidate_remark_for_second_ctc_offer = candidate_remark_for_second_ctc_offer;
	}

	public String getThird_ctc_offer() {
		return third_ctc_offer;
	}

	public void setThird_ctc_offer(String third_ctc_offer) {
		this.third_ctc_offer = third_ctc_offer;
	}
	...
	public String getCandidate_remark_for_third_ctc_offer() {
		return candidate_remark_for_third_ctc_offer;
	}

	public void setCandidate_remark_for_third_ctc_offer(String candidate_remark_for_third_ctc_offer) {
		this.candidate_remark_for_third_ctc_offer = candidate_remark_for_third_ctc_offer;
	}

	public String getExp_current_salary_in_lpa() {
		return exp_current_salary_in_lpa;
	}

	public void setExp_current_salary_in_lpa(String exp_current_salary_in_lpa) {
		this.exp_current_salary_in_lpa = exp_current_salary_in_lpa;
	}

	public String getDoc_upload_flag() {
		return doc_upload_flag;
	}

	public void setDoc_upload_flag(String doc_upload_flag) {
		this.doc_upload_flag = doc_upload_flag;
	}
	...
	public String getTest_status_flagg() {
		return test_status_flagg;
	}

	public void setTest_status_flagg(String test_status_flagg) {
		this.test_status_flagg = test_status_flagg;
	}

	public String getUser_login_status_expiration() {
		return user_login_status_expiration;
	}

	public void setUser_login_status_expiration(String user_login_status_expiration) {
		this.user_login_status_expiration = user_login_status_expiration;
	}
	...
	public String toString() {
		return "MoatCandidate_Entity [id=" + id + ", first_name=" + first_name + ", last_name=" + last_name
				+ ", gender=" + gender + ", email=" + email + ", password=" + password + ", mobile_number="
				...
				+ aadhar_pic + ", tenth_pic=" + tenth_pic + ", puc_pic=" + puc_pic + ", degree_pic=" + degree_pic
				+ ", exp_letter_pic=" + exp_letter_pic + ", pg_pic=" + pg_pic + ", payslip_pic=" + payslip_pic
				+ ", first_ctc_offer=" + first_ctc_offer + ", candidate_response_for_first_ctc_offer="
				+ candidate_response_for_first_ctc_offer + ", candidate_remark_for_first_ctc_offer="
				+ candidate_remark_for_first_ctc_offer + ", second_ctc_offer=" + second_ctc_offer
				+ ", candidate_response_for_second_ctc_offer=" + candidate_response_for_second_ctc_offer
				+ ", candidate_remark_for_second_ctc_offer=" + candidate_remark_for_second_ctc_offer
				+ ", third_ctc_offer=" + third_ctc_offer + ", candidate_response_for_third_ctc_offer="
				+ candidate_response_for_third_ctc_offer + ", candidate_remark_for_third_ctc_offer="
				+ candidate_remark_for_third_ctc_offer + ", exp_current_salary_in_lpa=" + exp_current_salary_in_lpa
				+ ", doc_upload_flag=" + doc_upload_flag + ", test_status_flagg=" + test_status_flagg
				+ ", user_login_status_expiration=" + user_login_status_expiration + ", diploma_pic=" + diploma_pic
				+ ", bank_check_pic=" + bank_check_pic + ", other_pic=" + other_pic + "]";
	}
