...
SELECT ae.*, CONCAT(e.f_name, ' ', e.l_name) AS emp_name FROM appraisal_employee ae INNER JOIN employee_details e ON ae.emp_id = e.empid
WHERE ae.department = :dept AND ae.apprisal_admin_flag::int = 1;
