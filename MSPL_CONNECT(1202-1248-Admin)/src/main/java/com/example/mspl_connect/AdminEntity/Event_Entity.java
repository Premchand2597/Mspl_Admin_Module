...
public class Event_Entity {
	...
	public String toString() {
		return "Event_Entity [id=" + id + ", announced_date=" + announced_date + ", event_title=" + event_title
				+ ", event_date=" + event_date + ", from_time=" + from_time + ", to_time=" + to_time + ", event_desc="
				+ event_desc + ", event_location=" + event_location + ", announcement_converted_flag="
				+ announcement_converted_flag + ", event_pic=" + event_pic + ", event_video=" + event_video + "]";
	}
}
