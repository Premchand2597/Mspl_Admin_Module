...
public class DeliveryChallanDTO {
	   public DeliveryChallanDTO(Long id, String supplierAddress, String buyer, String deliveryNoteNo, LocalDate dated,
			...
			String createdByName, String billingCompanyName, Double roundedGrandTotal, String deliveryAddress,
