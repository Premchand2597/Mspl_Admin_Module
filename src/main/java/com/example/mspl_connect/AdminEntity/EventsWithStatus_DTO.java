...
public class EventsWithStatus_DTO {
	...
	public String toString() {
		return "EventsWithStatus_DTO [id=" + id + ", announced_date=" + announced_date + ", event_title=" + event_title
				+ ", event_date=" + event_date + ", from_time=" + from_time + ", to_time=" + to_time + ", event_desc="
				+ event_desc + ", event_location=" + event_location + ", event_status=" + event_status
				+ ", event_pic_base64=" + event_pic_base64 + ", announcement_converted_flag="
				+ announcement_converted_flag + ", event_pic=" + event_pic + "]";
	}
