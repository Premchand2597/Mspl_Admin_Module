...
public class ChatController {
	...
	/*  @MessageMapping("/chat.sendMessage")
	  ...
	  public ResponseEntity<String> deleteMessage(@PathVariable Long id) {
		 // System.out.println("deleteing the messages");
	      try {
	          Optional<ChatMessage> messageToDelete = chatMessageRepository.findById(id);
	          //System.out.println("deleteing the messages " + messageToDelete);
	          if (messageToDelete.isPresent()) {
	              chatMessageRepository.deleteById(id); // Delete the message
