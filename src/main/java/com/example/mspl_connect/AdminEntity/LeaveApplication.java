...
public class LeaveApplication {
		...
		public LeaveApplication(int id, String empid, String approvedstatus, String approved_by, Integer department,
			...
			String leaveDuration, String remarks, String sender_id, String dailyDurations, String dailyHalves) {
		super();
		this.id = id;
		this.empid = empid;
		...
		@Column(name= "leave_duration")
	   	...
	   	public LeaveApplication(int id, String empid, String approvedstatus, String approved_by, Integer department,
				...
				Boolean is_date_modified, String old_from_date, String old_to_date, String requested_date,
				Integer edit_flag, String approvingAuthority, String approved_date_time, String profile_pic_path,
				String leaveDuration, String remarks, String sender_id, String dailyDurations) {
			super();
			this.id = id;
			this.empid = empid;
			this.approvedstatus = approvedstatus;
		...
		public String getDailyDurations() {
			return dailyDurations;
		}

		public void setDailyDurations(String dailyDurations) {
			this.dailyDurations = dailyDurations;
		}
		...
		@Column(name="sender_id")
	   	...
	   	@Column(name="daily_durations")
	   	private String dailyDurations;  // store JSON string

	   	@Column(name = "daily_halves")
		...
		public String getApproved_date_time() {
			return approved_date_time;
		}

		public void setApproved_date_time(String approved_date_time) {
			this.approved_date_time = approved_date_time;
		}
		...
		public void setEmployeeEmail(String employeeEmail) {
		 ...
		 public String getFinancialYear() {
			    ...
			    LocalDate financialYearStart, financialYearEnd;

			    // Check if the date is before March 26
			    if (fromDateParsed.isBefore(LocalDate.of(year, 3, 26))) {
			        financialYearStart = LocalDate.of(year - 1, 3, 26);
			        financialYearEnd = LocalDate.of(year, 3, 25);
			        return (year - 1) + "-" + year;
			    } else {
			        financialYearStart = LocalDate.of(year, 3, 26);
			        financialYearEnd = LocalDate.of(year + 1, 3, 25);
			        return year + "-" + (year + 1);
			    }
			}
		    ...
		    public LeaveApplication(int id, String empid, String approvedstatus, String approved_by, Integer department,
					...
					String previous_status, int notification_status, String timestamp, Integer status_count,
					Boolean is_date_modified, String old_from_date, String old_to_date, String requested_date,
					Integer edit_flag, String approvingAuthority, String approved_date_time, String leaveDuration,
					String remarks, String request_sender) {
				super();
				this.id = id;
				this.empid = empid;
				this.approvedstatus = approvedstatus;
			...
			public String toString() {
				return "LeaveApplication [id=" + id + ", empid=" + empid + ", approvedstatus=" + approvedstatus
						...
						+ approvingAuthority + ", approved_date_time=" + approved_date_time + ", profile_pic_path="
						+ profile_pic_path + ", leaveDuration=" + leaveDuration + ", remarks=" + remarks
						+ ", sender_id=" + sender_id + "]";
			}
			...
			public String getDailyHalves() {
				return dailyHalves;
			}

			public void setDailyHalves(String dailyHalves) {
				this.dailyHalves = dailyHalves;
			}
