...
//                                                @Param("op4") String op4, @Param("answers") String answers);
    ...
    @Transactional
    @Modifying
    @Query(nativeQuery = true, value = "INSERT INTO apttitude_question_backup(id, questions, op1, op2, op3, op4, answers) VALUES(cast(:id as integer), :questions, :op1, :op2, :op3, :op4, :answers)")
	void insertApptitudeQuestionsBackup(@Param("questions") String questions, @Param("id") String id,
                                                @Param("op1") String op1, @Param("op2") String op2, @Param("op3") String op3, 
                                                @Param("op4") String op4, @Param("answers") String answers);
	...
	@Transactional
    @Modifying
    @Query(nativeQuery = true, value = "INSERT INTO c_questions_backup(id, questions, op1, op2, op3, op4, answers) VALUES(cast(:id as integer), :questions, :op1, :op2, :op3, :op4, :answers)")
    ...
    @Transactional
    @Modifying
    @Query(nativeQuery = true, value = "INSERT INTO java_questions_backup(id, questions, op1, op2, op3, op4, answers) VALUES(cast(:id as integer), :questions, :op1, :op2, :op3, :op4, :answers)")
    ...
    @Transactional
    @Modifying
    @Query(nativeQuery = true, value = "INSERT INTO python_questions_backup(id, questions, op1, op2, op3, op4, answers) VALUES(cast(:id as integer), :questions, :op1, :op2, :op3, :op4, :answers)")
    ...
    @Transactional
    @Modifying
    @Query(nativeQuery = true, value = "INSERT INTO sql_questions_backup(id, questions, op1, op2, op3, op4, answers) VALUES(cast(:id as integer), :questions, :op1, :op2, :op3, :op4, :answers)")
